...
|Value of `UPS_MEMORY_REQUEST` environment variable passed to operator

|unifiedPushCpuLimit
|Limit of CPU which will be available for the UnifiedPush Service container
|Value of `UPS_CPU_LIMIT` environment variable passed to operator

|unifiedPushCpuRequest
|CPU resource which will be available for the UnifiedPush Service container
|Value of `UPS_CPU_REQUEST` environment variable passed to operator

|oAuthMemoryLimit
|Limit of Memory which will be available for the OAuth container
|Value of `OAUTH_MEMORY_LIMIT` environment variable passed to operator

|oAuthMemoryRequest
|Limit of Memory Request which will be available for the OAuth container
|Value of `OAUTH_MEMORY_REQUEST` environment variable passed to operator

|oAuthCpuLimit
|Limit of CPU which will be available for the OAuth container
|Value of `OAUTH_CPU_LIMIT` environment variable passed to operator

|oAuthCpuRequest
|CPU resource which will be available for the OAuth container
|Value of `OAUTH_CPU_REQUEST` environment variable passed to operator

|postgresMemoryLimit
|Limit of Memory which will be available for the Postgres container
|Value of `POSTGRES_MEMORY_LIMIT` environment variable passed to operator

|postgresMemoryRequest
|Limit of Memory Request which will be available for the Postgres container
|Value of `UPS_MEMORY_LIMIT` environment variable passed to operator

|postgresCpuLimit
|Limit of CPU which will be available for the Postgres container
|Value of `POSTGRES_CPU_LIMIT` environment variable passed to operator

|postgresCpuRequest
|CPU resource which will be available for the Postgres container
|Value of `POSTGRES_CPU_REQUEST` environment variable passed to operator
...
.Defaults for resource sizes, limits and requests
|===
|Variable |Default value | CR field
